...
<head>
    ...
    <title>Contatos IRMEN - Por Setor</title>
    <style>
        body {
        ...
        .logo {
            ...
            display: block; /* Garante que ela se comporte como um bloco para o margin auto */
            margin-left: auto;
            margin-right: auto;
        }
        h1 {
        ...
        <div class="sector">
            ...
            <div class="contact-card">
                ...
                <div class="buttons">
                    ...
                    <button class="whatsapp-btn" onclick="window.open('https://wa.me/5531984046094', '_blank')">WhatsApp</button>
                </div>
            </div>
        </div>
